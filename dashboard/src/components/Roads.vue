      ...
      methods: {
        ...
        async save () {
          if (this.editedIndex > -1) {
            ...
            Object.assign(this.roads[this.editedIndex], this.editedItem)
          } else {
            this.addRoad(this.editedItem)
            this.roads.push(this.editedItem)
          }
          this.close()
        },
      },
                      ...
                      <div class="card card-rounded">
                        <div class="card-body">
                          ...
                          <div class="table-responsive  mt-1">
                            <v-data-table :headers="headers" :items="roads"
                              :sort-by="[{ key: 'calories', order: 'asc' }]" class="elevation-1">
                              <template v-slot:top>
                                <v-toolbar flat>
                                  <v-toolbar-title>Add road</v-toolbar-title>
                                      ...
                                      <v-card-text>
                                        <v-container>
                                          <v-row>
                                            ...
                                            <v-col cols="12" sm="6" md="4">
                                              <v-text-field v-model="editedItem.factor" label="Factory"></v-text-field>
                                            </v-col>
                                          </v-row>
                                        </v-container>
                                      </v-card-text>
